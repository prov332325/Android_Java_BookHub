...
public class BoardChatAdapter extends RecyclerView.Adapter<BoardChatAdapter.ChatViewHolder> {
    ...
    // 1. 생성자
    public BoardChatAdapter(Activity context) {mContext = context;}
    ...
    public BoardChatAdapter.ChatViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        // 쉐어드 값 가져오기. - 상세보기로 아이템 클릭할 때 들고 들어가야함 !!
                ...
                Log.d("게시판 chat 어댑터", "로그인 회원정보from 쉐어드:  " + current_login_memberInfo);
        ...
        BoardChatAdapter.ChatViewHolder holder = new BoardChatAdapter.ChatViewHolder(view);
        return holder;
    ...
    // 4. bind view holder
    @Override
    public void onBindViewHolder(@NonNull BoardChatAdapter.ChatViewHolder holder, int position) {
        // 아이템 데이터 클래스
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("게시판 <잡담> 상세보기 클릭 시도", "상세보기진입 시도 ");
                // 로그인한 상태인지 체크하기
                if (emailId.equals("")) {
                    ...
                    Log.d("게시판 <잡담>상세보기클릭", "게시판번호: " + item.getBoard_number() + ", 제목: "+ item.getTitle() + ", 카테고리: " + item.getCategory() + ",유저 이메일 아이디: " + emailId) ;
