...
public class RetrofitClient {
    ...
    private static final String BASE_URL = "http://ec2-3-39-255-234.ap-northeast-2.compute.amazonaws.com/"; //URL은 주소를 포함한 완전한 리소스의 경로를 의미하므로 http 명시 해줘야함.
    private static Retrofit retrofit = null;


    // http에서 실제 요청 되는 내용을 확인하기
