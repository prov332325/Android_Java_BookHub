...
public class MylibraryWantAdapter extends RecyclerView.Adapter<MylibraryWantAdapter.MylibraryWantViewHolder> {

    // 내 서재 <읽고 싶은 책 보기>에 대한  adapter 구성순서
    // 1. 생성자
    // 2. view holder
    ...
    private ArrayList<MylibraryWantData> wantData = new ArrayList<>();


    // 1. 생성자
    public MylibraryWantAdapter (Activity context) {mContext = context;}


    // 2. 뷰 홀더 클래스
    public class MylibraryWantViewHolder extends RecyclerView.ViewHolder {
        ...
        // 뷰홀더의 생성자
        public MylibraryWantViewHolder (View view, int viewType) {
            super(view);
        ...
        // 아이템 세팅을 위한 메소드
        public void setItem (MylibraryWantData item) {
    ...
    @NonNull
    @Override
    public MylibraryWantAdapter.MylibraryWantViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MylibraryWantAdapter.MylibraryWantViewHolder holder = new MylibraryWantAdapter.MylibraryWantViewHolder(view, viewType);
        return holder;
    }

    // 4. bind view holder
    @Override
    public void onBindViewHolder (@NonNull MylibraryWantAdapter.MylibraryWantViewHolder holder, final int position) {
        MylibraryWantData item = wantData.get(position);
        holder.setItem(item);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("내 서재<읽고싶은 책> 상세보기 클릭 시도", "상세보기진입 시도 ");
    ...
    // 5. get item cnt
    @Override
    public int getItemCount() {return wantData.size(); }


    // 6. add item
    public void addItem (MylibraryWantData wantitem) {
        wantData.add(wantitem);
        notifyDataSetChanged(); // 시간순 정렬
    }
